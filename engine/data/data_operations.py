...
Contains util functions for manipulating the data
...
def add_organizations(orgs):
  ...
  with open('data/organizations/explicit_organizations','wb') as fp:
    pickle.dump(organizations, fp)
  with open('data/organizations/avoid_organizations','wb') as fp:
...
def add_skills(skills_to_add):
  ...
  with open('data/skills/skills','wb') as fp:
