...
export class PipelineGridComponent implements OnChanges {
    ...
    setPipeLinesApplicant() {
        ...
        for (let index = 0; index < this.Applicants.length; index++) {
            console.log('this.JobApplicants[index].applicant', this.Applicants[index]);
        ...
        console.log(' this.pipeLinesApplicant', this.pipeLinesApplicant);
    }
    ...
    eventHandler(event: any) {
        console.log('eventHandlereventHandlereventHandlereventHandler', event);
        if (event.applicant) {
    ...
    onCandidateReject(event: any) {
        console.log('onCandidateRejectonCandidateRejectonCandidateReject', event);
    ...
    onColumnDrag(event, item, i) {
        console.log('onColumnDragevent', event);
        console.log('onColumnitem', item);
